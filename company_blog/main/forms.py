...
class BlogPostForm(FlaskForm):
    ...
    picture1 = StringField('スクショ', validators=[FileAllowed(['jpg', 'png'])])
    picture2 = StringField('スクショ', validators=[FileAllowed(['jpg', 'png'])])
    picture3 = StringField('スクショ', validators=[FileAllowed(['jpg', 'png'])])
    picture4 = StringField('スクショ', validators=[FileAllowed(['jpg', 'png'])])
    picture5 = StringField('スクショ', validators=[FileAllowed(['jpg', 'png'])])
    picture6 = StringField('スクショ', validators=[FileAllowed(['jpg', 'png'])])
    picture7 = StringField('スクショ', validators=[FileAllowed(['jpg', 'png'])])
    picture8 = StringField('スクショ', validators=[FileAllowed(['jpg', 'png'])])
    picture9 = StringField('スクショ', validators=[FileAllowed(['jpg', 'png'])])
    picture10 = StringField('スクショ', validators=[FileAllowed(['jpg', 'png'])])
